...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectizeInput("corr_x", label = "x Variable", choices = numeric_vars),
      selectizeInput("corr_y", label = "y Variable", choices = numeric_vars),
      ...
      radioButtons("hhl_corr", label = "Household Language", choices = list(
        "All" = "all",
      ...
      radioButtons("fs_corr", label = "SNAP Recipient", choices = list(
        "All" = "all",
        "Yes" = "yes",
        "No" = "no"
      )),
      radioButtons("schl_corr", label = "Educational attainment", choices = list(
        "All" = "all",
